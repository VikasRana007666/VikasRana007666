...
I'm a **Full-Stack Web Developer** with a strong focus on building clean, **SEO-optimized** applications. When I'm not coding, I'm experimenting with the latest **generative AI media models**.

- 🔭 Crafting robust applications using **Laravel, Node.js, and React**
- 🎨 Building responsive interfaces with **Bootstrap 5**, **Bootstrap Icons**, and **jQuery** — dark mode always on
- 📈 Developing platforms designed to capture hidden keyword demand and rank efficiently
- 🤖 Running and fine-tuning image-to-video / text-to-video models (**Veo, Wan 2.1, ComfyUI**) via Google Colab
...
<table>
  <tr>
    ...
    <td width="50%" valign="top">
      ...
      <a href="https://vikaskaimwal.co.in/"><img src="https://img.shields.io/badge/Visit-vikaskaimwal.co.in-0f172a?style=for-the-badge&logo=laravel&logoColor=FF2D20" /></a>
    </td>
  </tr>
</table>
...
<p align="left">
  ...
  <img src="https://img.shields.io/badge/ComfyUI-6E56CF?style=for-the-badge&logo=stableboost&logoColor=white" alt="ComfyUI" />
